    ...
    <div class="container-fluid">
      ...
      <form class="d-flex">
        <input
          ...
          aria-label="Search"
        />
        <button class="btn  btn-outline-light" type="submit">Yet</button>
      </form>
    </div>
  </nav>
</template>
